...
struct MaxPoolNew {
    struct operation_attributes_t {
        ...
        // operation_attributes_t(const tt::tt_metal::SlidingWindowConfig& sliding_window_config, const MemoryConfig& memory_config)
        //     : sliding_window_config_(sliding_window_config), memory_config_(memory_config) {}

        // size_t size() const {
        //     return sizeof(sliding_window_config_) + sizeof(memory_config_);
        // }
    };
    ...
    static shape_return_value_t compute_output_shapes(const Tensor& input, const tt::tt_metal::SlidingWindowConfig& sliding_window_config, const MemoryConfig& out_mem_config);
    static tensor_return_value_t create_output_tensors(const Tensor &input, const tt::tt_metal::SlidingWindowConfig& sliding_window_config, const MemoryConfig& out_mem_config);
