...
operation::ProgramWithCallbacks reduce_single_core_hw(const Tensor &a, Tensor& output, ReduceOpMath reduce_op, float scaler, const std::optional<DeviceComputeKernelConfig>& compute_kernel_config) {
